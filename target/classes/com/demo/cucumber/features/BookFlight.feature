Feature: Book Flight for an Adult
  ...
  Scenario Outline: Process automates the steps to book a flight till the payment page displayed
    ...
    Then Verify Review Itinerary page is displayed
    And Fill the contact details: "<mobNo>", "<email>" and traveller details: "<firstName>", "<lastName>", "<gender>", "<dob>" and click on continue payment button

    Examples: 
      | BrowserName | tripType | departFrom | ArrivalTo | departDate        | returnOn          | mobNo      | email                      | firstName | lastName | gender | dob        |
      | chrome      | round    | BLR        | IXR       | Sat, 28 Nov, 2020 | Thu, 24 Dec, 2020 | 8093239980 | subodh.kumar9251@gmail.com | subodh    | kumar    | Male   | 19/07/1992 |
